...
(
  relation["admin_level"="10"]["name"~"179|18[0-8]|Tala|Amparo|Pangarap",i](14.73, 121.04, 14.79, 121.14);
  way["admin_level"="10"]["name"~"179|18[0-8]|Tala|Amparo|Pangarap",i](14.73, 121.04, 14.79, 121.14);
);
out geom;\;
          ...
          if(f.geometry && f.geometry.coordinates) {
              ...
              if (f.geometry.type === 'Polygon') {
                  ...
                  if (polyPath.length >= 3) {
                     // try to close the linestring generically
  ...
  console.log(\Found \ matching geometries! Saving...\);
  ...
  if (master) {
      ...
      const regex = /export const NORTH_CALOOCAN_POLYGON\s*=\s*(?:\[|\s|[-.0-9,\[\]]+)*;/m;
      // using regex replacer carefully over exact block
