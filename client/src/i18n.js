    ...
    resources: {
      en: {
        translation: {
          ...
          // Learn Page
          learn: {
            badge: 'FLOODSENSE EDUCATION CENTER',
            hero: {
              title1: 'Stay Informed.',
              title2: 'Stay Safe. Stay Prepared.',
              subtitle: 'FloodSense helps you not only monitor floods but understand them too. Learn how floods develop, how to respond safely, and how your community stays resilient through knowledge and preparedness.',
            },
            whatCauses: {
              title: 'What Causes',
              titleHighlight: 'Floods?',
              description: 'Floods occur when rainfall, drainage systems, and terrain combine in ways that overwhelm natural or man-made water channels. In North Caloocan and other cities, floods are often the result of heavy rainfall, clogged drainage systems, or rising river levels. FloodSense sensors monitor these conditions to help predict and alert the community before water levels become dangerous.',
            },
            deepDive: {
              title: 'Deep Dive into',
              titleHighlight: 'FloodSense',
              subtitle: 'Discover how our system works and its impact',
              tabs: {
                overview: 'Overview',
              ...
              content: {
                overviewTitle: 'About FloodSense North Caloocan',
                overviewDesc: 'FloodSense North Caloocan is an innovative Internet of Things-based flood monitoring and reporting system designed to address the persistent challenge of flooding in Caloocan City. By integrating cutting-edge technology with community participation, the system provides accurate flood intelligence to enhance public safety and disaster preparedness.',
                technologyTitle: 'How Our Technology Works',
                technologyDesc: 'Our system integrates ultrasonic sensors with ESP32 microcontrollers to automatically measure water levels in real-time. This data is transmitted via Wi-Fi to our secure Node.js server and stored in a MongoDB database. The React-based web platform ensures seamless data visualization and user interaction.',
                communityTitle: 'Community Participation',
                communityDesc: 'Residents play a vital role in flood monitoring by submitting reports through our platform. These reports are validated by barangay officials to ensure accuracy. Once verified, both sensor data and community reports are displayed on our public dashboard and interactive flood map.',
                benefitsTitle: 'Benefits and Impact',
                benefitsDesc: 'Real-time flood alerts for commuters and drivers • Faster emergency response using validated data • Improved decision-making for local authorities • Enhanced community awareness and preparedness • Stronger collaboration between citizens and government',
              }
            },
            features: {
              title: 'Key',
              titleHighlight: 'Features',
              subtitle: 'How FloodSense combines technology and community',
              feature1: 'Real-time Monitoring',
              feature1Desc: 'Ultrasonic sensors provide continuous water level measurements with high accuracy',
              feature2: 'Community Reporting',
              feature2Desc: 'Residents contribute local flood intelligence through our web platform',
              feature3: 'Validated Data',
              feature3Desc: 'Barangay officials verify all community reports for accuracy and reliability',
              feature4: 'User-Friendly Dashboard',
              feature4Desc: 'Easy-to-use interface displaying real-time flood alerts and safety updates',
            },
            resources: {
              title: 'Educational',
              titleHighlight: 'Resources',
              subtitle: 'Download comprehensive guides and documentation',
              thesis: 'Project Thesis Document',
              thesisDesc: 'Complete research paper detailing the FloodSense system',
              safety: 'Flood Safety Guidelines',
              safetyDesc: 'Essential safety steps during flood emergencies',
              manual: 'Sensor Manual',
              manualDesc: 'Technical documentation for flood monitoring sensors',
              download: 'Download',
            },
            faq: {
              title: 'Frequently',
              titleHighlight: 'Asked Questions',
              subtitle: 'Common questions about FloodSense and how it works',
              q1: 'What is FloodSense and how does it work?',
              a1: 'FloodSense is an Internet of Things-based flood monitoring system that integrates ultrasonic sensors with community reporting. Sensors measure water levels in real-time and send data to our server, while residents can submit flood reports that are validated by barangay officials before appearing on our public dashboard.',
              q2: 'How accurate are the flood sensors?',
              a2: 'Our ultrasonic sensors provide high accuracy in water level measurement with a very small margin of error. ESP32 microcontrollers process data in real-time and send updates every few minutes. Additionally, all community reports are validated by local officials to ensure accuracy.',
              q3: 'Can I access FloodSense data for free?',
              a3: 'Yes! FloodSense is committed to transparency and public safety. All flood monitoring data, verified reports, and alerts are freely accessible through our dashboard and interactive map. We believe critical safety information should be available to everyone.',
              q4: 'How do I report a flood incident?',
              a4: 'You can submit flood reports directly through our web platform. Simply go to the reporting section, provide location details and observations, and submit. Your report will be reviewed by barangay officials for verification before appearing on the public dashboard.',
              q5: 'Who validates community flood reports?',
              a5: 'All community-submitted reports are validated by authorized barangay officials in North Caloocan. This validation process ensures that only accurate and trustworthy information reaches the public dashboard, maintaining the reliability of our system.',
              q6: 'What should I do during a flood emergency?',
              a6: 'FloodSense provides information but is NOT an emergency response service. During active flooding, prioritize your safety: move to higher ground, avoid floodwaters, and contact your local barangay office or call 911 for emergency assistance.',
          ...
          // About Page
          about: {
            badge: 'ABOUT FLOODSENSE',
            hero: {
              title: 'Where Technology',
              titleHighlight: 'Saves Lives',
              subtitle: 'FloodSense is a pioneering Internet of Things-based flood monitoring system born from a desire to protect communities through intelligent technology and collective action.',
            },
            stats: {
              studentBuilt: 'Student-Built',
              studentBuiltDesc: 'Developed by passionate computer science students as a capstone thesis project',
              communityFocused: 'Community-Focused',
              communityFocusedDesc: 'Designed with direct input from North Caloocan residents and local officials',
              openInnovation: 'Open Innovation',
              openInnovationDesc: 'Committed to transparency and continuous improvement through collaboration',
            },
            mission: {
              title: 'Our',
              titleHighlight: 'Mission',
              description: 'Our mission is to transform flood disaster management in Caloocan City by integrating an Internet of Things sensor network with community-driven reporting—creating a transparent, reliable, and real-time flood intelligence system that empowers residents to make informed decisions during emergencies.',
              vision: 'Vision',
              visionDesc: 'A flood-resilient community where technology and people work together.',
              goal: 'Goal',
              goalDesc: 'Zero casualties through proactive flood intelligence and rapid response.',
              location: 'Serving North Caloocan, Philippines',
            },
            journey: {
              title: 'The FloodSense',
              titleHighlight: 'Journey',
              subtitle: 'From concept to community impact',
              phase1: 'Ideation',
              phase1Title: 'Identifying the Problem',
              phase1Desc: 'Caloocan City experiences recurring floods that disrupt thousands of lives. Traditional monitoring systems are reactive, not proactive.',
              phase2: 'Development',
              phase2Title: 'Building the Solution',
              phase2Desc: 'Our team created an Internet of Things-powered ecosystem that integrates ultrasonic sensors, real-time data processing, and community validation.',
              phase3: 'Launch',
              phase3Title: 'Empowering Communities',
              phase3Desc: 'FloodSense now serves North Caloocan residents with 24/7 monitoring, verified alerts, and actionable flood intelligence.',
            },
            values: {
              title: 'Our Core',
              ...
              communityDrivenDesc: 'Technology is only as strong as the people who use it. We built FloodSense with community input at every stage.',
              safetyFirst: 'Safety First',
              safetyFirstDesc: 'Every line of code, every sensor, every alert—designed with one purpose: keeping residents safe during emergencies.',
              innovation: 'Innovation',
              innovationDesc: 'We use cutting-edge Internet of Things, real-time databases, and modern web technology to solve age-old problems.',
              transparency: 'Transparency',
              transparencyDesc: 'Open data, verified reports, and honest communication build trust between technology and community.',
            },
            tech: {
              title: 'Built with',
              titleHighlight: 'Modern Technology',
              subtitle: 'A complete solution from sensors to screen',
              iotHardware: 'IoT Hardware',
              iot1: 'ESP32 Microcontrollers',
              iot2: 'Ultrasonic Sensors',
              iot3: 'Real-time Telemetry',
              backend: 'Backend',
              backend1: 'Node.js Server',
              backend2: 'MongoDB Database',
              backend3: 'RESTful APIs',
              frontend: 'Frontend',
              frontend1: 'React Framework',
              frontend2: 'Real-time Dashboard',
              frontend3: 'Interactive Maps',
              community: 'Community',
              community1: 'Citizen Reporting',
              community2: 'Barangay Validation',
              community3: 'Public Alerts',
            },
            student: {
              title: 'A Student-Led',
              titleHighlight: 'Innovation',
              description: 'FloodSense was built as a capstone thesis project by passionate computer science students who saw technology not just as code and circuits—but as a tool to protect their community and save lives.',
              capstone: 'Capstone Project 2024-2025',
            },
          },
          // Auth
          auth: {
            ...
            resetPassword: {
              ...
              invalidToken: 'Reset link is invalid or expired. Please request a new one.',
        ...
        translation: {
          ...
          auth: {
            ...
            forgotPassword: {
              ...
              subtitle: 'Ilagay ang email ng iyong account at magpapadala kami ng reset link.',
              emailLabel: 'Email Address',
              emailPlaceholder: 'your@email.com',
              submitButton: 'Magpadala ng Reset Link',
              sending: 'Nagpapadala...',
              successTitle: 'Suriin ang iyong email',
              successMessage: 'Kung may account sa email na ito, naipadala na ang reset link.',
              backToLogin: 'Bumalik sa Sign In',
              tryAgain: 'Subukan ang ibang email',
              required: 'Pakilagay ang iyong email address.',
              invalidEmail: 'Pakilagay ang wastong email address.',
              error: 'Hindi maproseso ang request. Pakisubukang muli.',
            },
            resetPassword: {
              title: 'Gumawa ng bagong password',
              subtitle: 'Ilagay ang bago mong password sa ibaba.',
              passwordLabel: 'Bagong Password',
              confirmPasswordLabel: 'Kumpirmahin ang Bagong Password',
              submitButton: 'I-reset ang Password',
              resetting: 'Nire-reset...',
              success: 'Matagumpay na na-reset ang password. Mag-sign in gamit ang bagong password.',
              invalidToken: 'Hindi wasto o paso na ang reset link. Humingi ng panibago.',
              missingToken: 'Walang reset token. Humingi ng bagong reset link.',
              passwordMin: 'Dapat hindi bababa sa 6 na character ang password.',
